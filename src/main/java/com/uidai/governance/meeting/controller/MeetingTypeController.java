...
public class MeetingTypeController {
    ...
    public List<MeetingTypeDto> list(@RequestParam(defaultValue = "true") boolean activeOnly) {
    ...
    public MeetingTypeDto create(@Valid @RequestBody MeetingTypeDto dto) {
        return service.create(dto);
    }

    @PutMapping("/{id}")
    @Operation(summary = "Update a meeting type")
    public MeetingTypeDto update(@PathVariable Long id, @Valid @RequestBody MeetingTypeDto dto) {
